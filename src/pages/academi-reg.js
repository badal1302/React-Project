    ...
    return (
        <main>
            ...
            <section className="full_row register_p containerx boxed_wrapper">
                <form action="/academic-reg" method="post" className="reg_log_div">
                    <h2 className="section_title  align_center section_title_sm">Register as  academia</h2>
